...
VALID_LED_MATRIX_TYPES := IS31FL3731 IS31FL3741A IS31FL3742A IS31FL3743A IS31FL3745 IS31FL3746A CKLED2001 custom
...
ifneq (,$(filter $(MCU), atmega16u2 atmega32u2 at90usb162))
    ...
    ifeq ($(strip $(LED_MATRIX_DRIVER)), IS31FL3741A)
        OPT_DEFS += -DIS31FL3741A -DSTM32_I2C -DHAL_USE_I2C=TRUE
        COMMON_VPATH += $(DRIVER_PATH)/led/issi
        SRC += is31fl3741.c
        QUANTUM_LIB_SRC += i2c_master.c
    endif
